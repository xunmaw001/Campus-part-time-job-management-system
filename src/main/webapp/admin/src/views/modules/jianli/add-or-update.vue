        ...
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="求职方向" prop="jianliTypes">
                        <el-select v-model="ruleForm.jianliTypes" :disabled="ro.jianliTypes" placeholder="请选择求职方向">
                            <el-option
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jianliTypes: [
                              { required: true, message: '求职方向不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
