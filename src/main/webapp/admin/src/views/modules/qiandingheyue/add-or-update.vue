    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='gongsi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="账户" prop="username">
                        <el-input v-model="gongsiForm.username"
                ...
                <el-col :span="12"  v-if="sessionTable !='gongsi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="密码" prop="password">
                        <el-input v-model="gongsiForm.password"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.qiandingheyueFile" label="合同文件" prop="qiandingheyueFile">
                        <file-upload
                                tip="点击上传合同文件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.qiandingheyueFile?ruleForm.qiandingheyueFile:''"
                                @change="qiandingheyueFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.qiandingheyueFile" label="合同文件" prop="qiandingheyueFile">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.qiandingheyueFile || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="有效期限" prop="qiandingheyueQixian">
                       <el-input v-model="ruleForm.qiandingheyueQixian"
                                 placeholder="有效期限" clearable  :readonly="ro.qiandingheyueQixian"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="有效期限" prop="qiandingheyueQixian">
                           <el-input v-model="ruleForm.qiandingheyueQixian"
                                     placeholder="有效期限" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="详细条款" prop="qiandingheyueText">
                        <el-input type="textarea"  :readonly="ro.qiandingheyueText" v-model="ruleForm.qiandingheyueText" placeholder="详细条款"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.qiandingheyueText" label="详细条款" prop="qiandingheyueText">
                            <span v-html="ruleForm.qiandingheyueText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    gongsiId: false,
                    yonghuId: false,
                    qiandingheyueFile: false,
                    qiandingheyueQixian: false,
                    qiandingheyueText: false,
                },
                ruleForm: {
                    gongsiId: '',
                    yonghuId: '',
                ...
                rules: {
                   ...
                   qiandingheyueText: [
                              { required: true, message: '详细条款不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`qiandingheyue/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.qiandingheyueCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            qiandingheyueFileUploadChange(fileUrls){
                this.ruleForm.qiandingheyueFile = fileUrls;
                this.addEditUploadStyleChange()
            },
